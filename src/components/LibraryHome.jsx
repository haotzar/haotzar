    ...
    <div className="library-home">
      ...
      <div className="library-content">
        ...
        <div className="library-header">
          <h1 className="library-title">האוצר</h1>
              ...
              <div className="help-content">
                {showHelp === 'start' && (
                  <div className="help-section">
                    ...
                    <p>האוצר הוא מאגר דיגיטלי ענק של ספרי קודש, המאפשר לך לגשת למאות אלפי ספרים בקלות.</p>
                ...
                {showHelp === 'search' && (
                  <div className="help-section">
                    <h3>חיפוש במאגר</h3>
                    <p>מערכת החיפוש של האוצר מאפשרת לך למצוא בדיוק מה שאתה מחפש.</p>
                ...
                {showHelp === 'library' && (
                  <div className="help-section">
                    <h3>ניהול הספרייה</h3>
                    <p>ארגן את הספרים שלך בצורה יעילה עם כלי הניהול של האוצר.</p>
                ...
                {showHelp === 'terms' && (
                  <div className="help-section">
                    ...
                    <h4>רישיון ושימוש:</h4>
                    <p>האוצר הוא תוכנה חינמית לשימוש אישי.</p>
