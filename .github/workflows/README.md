...
- תכונות שדורשות גישה למערכת הקבצים המקומית לא יעבדו
- מתאים לתצוגה מקדימה ודמו של האפליקציה
- ה-base path מוגדר אוטומטית לפי שם הרפוזיטורי

### 📚 הוספת ספרים לאתר

הספרים צריכים להיות בתיקייה `public/books/`:

1. **צור תיקיות** לפי קטגוריות (תנך, משנה, וכו')
2. **הוסף קבצים**:
   - קבצי טקסט (`.txt`) בקידוד UTF-8
   - קבצי PDF (`.pdf`)
3. **עשה commit ו-push** - הספרים יופיעו באתר אוטומטית
...
**ראה:** `public/books/README.md` להוראות מפורטות
